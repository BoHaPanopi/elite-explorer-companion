...
const baseMessages = {
  de: {
    ...
    openSettings: "Einstellungen öffnen", configureNow: "Jetzt einrichten", setup: "Einrichtung", configureCrew: "Crew konfigurieren", crewResetToUiLanguage: "Alle auf UI-Sprache setzen", renameComputer: "Bordcomputer umbenennen", renameAvailableFrom015: "Das Umbenennen des Bordcomputers ist ab Version 0.15 verfügbar.",
  ...
  en: {
    ...
    openSettings: "Open Settings", configureNow: "Configure Now", setup: "Setup", configureCrew: "Configure Crew", crewResetToUiLanguage: "Use UI language for all", renameComputer: "Rename onboard computer", renameAvailableFrom015: "Renaming the onboard computer will be available from version 0.15.",
...
const messages = {
  ...
  fr: {
    ...
    openSettings: "Ouvrir les paramètres", configureNow: "Configurer maintenant", setup: "Configuration initiale", configureCrew: "Configurer l’équipage", crewResetToUiLanguage: "Utiliser la langue de l’interface pour tout", renameComputer: "Renommer l’ordinateur de bord", renameAvailableFrom015: "Le changement de nom de l’ordinateur de bord sera disponible à partir de la version 0.15.",
  ...
  it: {
    ...
    openSettings: "Apri impostazioni", configureNow: "Configura ora", setup: "Configurazione iniziale", configureCrew: "Configura equipaggio", crewResetToUiLanguage: "Usa la lingua UI per tutti", renameComputer: "Rinomina il computer di bordo", renameAvailableFrom015: "La ridenominazione del computer di bordo sarà disponibile a partire dalla versione 0.15.",
  ...
  es: {
    ...
    openSettings: "Abrir ajustes", configureNow: "Configurar ahora", setup: "Configuración inicial", configureCrew: "Configurar tripulacion", crewResetToUiLanguage: "Usar idioma de la interfaz para toda la tripulacion", renameComputer: "Cambiar el nombre del ordenador de a bordo", renameAvailableFrom015: "El cambio de nombre del ordenador de a bordo estará disponible a partir de la versión 0.15.",
