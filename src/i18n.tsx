...
const messages = {
  de: {
    ...
    updateWaitingTitle: "Elite Dangerous läuft noch.", updateWaitingBody: "Das Update wird installiert, sobald du das Spiel beendet hast.",
    updateServicesTitle: "OGG wartet auf freie Dateien.", updateServicesBody: "Das Update wird installiert, sobald alle OGG-Hintergrundprozesse beendet sind.",
  ...
  en: {
    ...
    updateWaitingTitle: "Elite Dangerous is still running.", updateWaitingBody: "The update will be installed as soon as you close the game.",
    updateServicesTitle: "OGG is waiting for its files to become available.", updateServicesBody: "The update will be installed as soon as all OGG background processes have stopped.",
