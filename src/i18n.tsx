...
const baseMessages = {
  de: {
    ...
    language: "Sprache", german: "Deutsch", english: "Englisch", french: "Französisch", italian: "Italienisch", spanish: "Spanisch", moduleHint: "Mia werggeln dro.", moduleProfileHint: "Automatik bleibt Standard. Manuelle Profile folgen als sichere Uebersteuerung.", automatic: "Automatisch", explorationProfile: "Exploration", miningProfile: "Mining", combatProfile: "Combat", tradeProfile: "Trade", currentSystem: "Aktuelles System",
    ...
    openSettings: "Einstellungen öffnen", configureNow: "Jetzt einrichten", setup: "Einrichtung", configureCrew: "Crew konfigurieren", renameComputer: "Bordcomputer umbenennen", renameAvailableFrom015: "Das Umbenennen des Bordcomputers ist ab Version 0.15 verfügbar.",
  ...
  en: {
    ...
    language: "Language", german: "German", english: "English", french: "French", italian: "Italian", spanish: "Spanish", moduleHint: "We're tinkering away.", moduleProfileHint: "Automatic remains the default. Manual profiles stay available as an intentional override.", automatic: "Automatic", explorationProfile: "Exploration", miningProfile: "Mining", combatProfile: "Combat", tradeProfile: "Trade", currentSystem: "Current System",
    ...
    openSettings: "Open Settings", configureNow: "Configure Now", setup: "Setup", configureCrew: "Configure Crew", renameComputer: "Rename onboard computer", renameAvailableFrom015: "Renaming the onboard computer will be available from version 0.15.",
...
const messages = {
  ...
  fr: {
    ...
    openSettings: "Ouvrir les paramètres", configureNow: "Configurer maintenant", setup: "Configuration initiale", configureCrew: "Configurer l’équipage", renameComputer: "Renommer l’ordinateur de bord", renameAvailableFrom015: "Le changement de nom de l’ordinateur de bord sera disponible à partir de la version 0.15.",
  ...
  it: {
    ...
    language: "Lingua", german: "Tedesco", english: "Inglese", french: "Francese", italian: "Italiano", spanish: "Spagnolo", moduleHint: "Ci stiamo lavorando.", moduleProfileHint: "La modalita automatica resta lo standard. I profili manuali restano disponibili come override intenzionale.", automatic: "Automatico", explorationProfile: "Esplorazione", miningProfile: "Mining", combatProfile: "Combattimento", tradeProfile: "Commercio", currentSystem: "Sistema attuale",
    ...
    openSettings: "Apri impostazioni", configureNow: "Configura ora", setup: "Configurazione iniziale", configureCrew: "Configura equipaggio", renameComputer: "Rinomina il computer di bordo", renameAvailableFrom015: "La ridenominazione del computer di bordo sarà disponibile a partire dalla versione 0.15.",
  ...
  es: {
    ...
    language: "Idioma", german: "Alemán", english: "Inglés", french: "Francés", italian: "Italiano", spanish: "Español", moduleHint: "Estamos trabajando en ello.", moduleProfileHint: "Automatico sigue siendo el estandar. Los perfiles manuales quedan como anulacion intencional.", automatic: "Automatico", explorationProfile: "Exploracion", miningProfile: "Mineria", combatProfile: "Combate", tradeProfile: "Comercio", currentSystem: "Sistema actual",
    ...
    openSettings: "Abrir ajustes", configureNow: "Configurar ahora", setup: "Configuración inicial", configureCrew: "Configurar tripulacion", renameComputer: "Cambiar el nombre del ordenador de a bordo", renameAvailableFrom015: "El cambio de nombre del ordenador de a bordo estará disponible a partir de la versión 0.15.",
